...
public class SpUtil {
    ...
    public static void putObject(Context context, String key, Object obj) {
        try {
            ...
            os.writeObject(obj);
            //将序列化的数据转为16进制保存
            String bytesToHexString = BaseUtil.byteArrayToHexStr(bos.toByteArray());
            //保存该16进制数组
     ...
     * modified:
     */
    public static <T extends Object> T readObject(Context context,String key ){
        try {
            ...
            if (sharedata.contains(key)) {
                ...
                if(TextUtils.isEmpty(string)){
                    ...
                    //将16进制的数据转为数组，准备反序列化
                    byte[] stringToBytes = BaseUtil.hexStrToByteArray(string);
