...
/**
 * @author zhoujunjie on 2017/12/19.
 */
...
public class FlowLayout extends ViewGroup {
    ...
    public class Line {
         ...
         * 子控件之间的横向距离
         */
        private float childWidthSpace;
        /**
         * 已经使用的宽度
         */
        private int usedWidth;

        public Line(int maxWidth, float childWidthSpace) {
            this.maxWidth = maxWidth;
            this.childWidthSpace = childWidthSpace;
        }
        ...
        public void addView(View view) {
            ...
            if (list.size() == 0) {
                ...
                usedWidth += viewWidth + childWidthSpace;
        ...
        public boolean canAddView(View view) {
            ...
            if (view.getMeasuredWidth() > maxWidth - usedWidth - childWidthSpace) {
                return false;
            }
            return true;
        }
        ...
        public void layout(int t, int l) {
            // 平分剩下的空间
            int avg = (maxWidth - usedWidth) / list.size();
            ...
            for (View view : list) {
                ...
                // 更新数据
                l += measuredWidth + childWidthSpace;
            }
        }
