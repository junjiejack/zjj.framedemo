...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements OnFocusChangeListener,
    ...
    private ClearTextChangeListener clearTextChangeListener;
    ...
    public void afterTextChanged(Editable s) {
        if(clearTextChangeListener != null){
            clearTextChangeListener.onTextChange(s);
        }
    }
    ...
    public void setClearTextChangeListener(ClearTextChangeListener listener){
        clearTextChangeListener = listener;
    }
